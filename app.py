...
def admin_dashboard_data():
    ...
    try:
        with conn.cursor() as cur:
            ...
            cur.execute("SELECT id,username,role,created_at,last_seen FROM users WHERE role!='admin' ORDER BY id DESC");users=cur.fetchall()
